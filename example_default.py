# A basic test of pyglet_grid with default parameters
#
...
# The simple_prepare() method sets up the grid with default parameters
# set for window size, grid size and cell size. These are demonstrated
# in the test_custom.py file.
grid.simple_prepare()
...
def update_faster(dt):
    ...
    #global counter
    #counter += 1
    #pyglet.image.get_buffer_manager().get_color_buffer().save(str(counter).zfill(10)+'.png')
